    ...
    <div className={`fixed top-0 z-40 py-4 bg-white shadow-sm transition-all duration-300 ${
      ...
      <div className="flex items-center justify-between h-full px-4 md:px-6 mx-auto">
        ...
        <div className="hidden md:block text-lg font-semibold text-gray-800">
          Hello, {username}! {isDemoMode && <span className="text-blue-600">(Demo Mode)</span>}
        </div>

        {/* Right side icons */}
        <div className="flex items-center gap-3 md:gap-4 lg:gap-6">
          {/* Demo mode toggle - desktop */}
          ...
          <div className="hidden md:block relative">
            ...
            <input 
              ...
              className="w-64 lg:w-80 h-10 pl-10 pr-4 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2563eb]/50 focus:border-[#2563eb]"
            />
          </div>
        ...
        <div className="md:hidden bg-white border-t border-gray-200 shadow-lg">
          <div className="px-4 py-2 space-y-2">
            <div className="px-3 py-2 text-sm font-medium text-gray-900">
              Hello, {username}! {isDemoMode && <span className="text-blue-600">(Demo)</span>}
            </div>
